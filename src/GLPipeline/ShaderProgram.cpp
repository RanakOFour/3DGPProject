...
void ShaderProgram::SetUniform(const std::string& _uniformName, glm::vec2 _value)
{
	glUniform3fv(glGetUniformLocation(m_id, _uniformName.c_str()), 2, glm::value_ptr(_value));
}
